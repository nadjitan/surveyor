...
const Surveyor: FC<PropsWithChildren<{
  ...
  let hoverDiv = useRef<HTMLDivElement>(null)
  ...
  useEffect(() => {
    ...
    document.onmousemove = (e: MouseEvent) => {
      ...
      if (targetClass) {
        const child = hoverDiv.current?.firstElementChild
        hoverDiv.current!.style.display = "fixed"
        child!.innerHTML = `<p>tag: ${target.tagName}</p><p>class: ${targetClass}</p>`
      }
    }
